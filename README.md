...
Criterion:
	...
	We also include a proof that SD implies XSD by showing how the former is a specific case of the later
    ...
    -- OXSD
	-- OXSD_Criterion.thy:
	   An alternative legacy definition of the Extended Sprenger-Dam Criterion (OXSD -- Old Extended Sprenger Dam) 
	   this definiton was presented in the first iteration of this work, and later refactored into the "sliced" version presented in the paper
	   To give confidence in our refactorisation we include this definition to show equivalence between the two.

	-- OXSD_Incomplete.thy:
	   A demonstration (identical to the one shown in the paper & XSD_incomplete) that this definition is also incomplete

	-- XSD_Equivalence.thy
	   Equivalence proofs between OXSD and XSD, as well as a result that SD implies OXSD.
